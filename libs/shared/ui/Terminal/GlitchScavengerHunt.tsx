...
export const GlitchScavengerHunt = ({terminal}: any) => {
  ...
  return (
    <div className="mini-game">
      ...
      <div className="game-canvas-container border-4 border-terminal-blue h-64 flex items-center justify-center mb-6 bg-black/30 relative overflow-hidden">
        ...
        {state.gameActive ? (
          <div className="text-center">
            <p className="text-terminal-red text-xl mb-4 font-bold animate-pulse">
              MARKETS ENGAGED!
            </p>
            <div className="text-terminal-green font-bold">
              <div className="mb-2 animate-flicker-slow">
                TRADING BLOCKCHAIN ASSETS...
              </div>
          ...
          <div className="text-center">
            <p className="text-terminal-red text-xl mb-4 font-bold animate-flicker-slow">
              {showWalletInput
                ...
                : "MARKET SIMULATOR READY - AWAITING INPUT"}
            </p>
            {!showWalletInput && (
              <pre className="text-terminal-green font-bold animate-pulse">
                ________________________ / \ | PRESS TRANSACTION KEY | | TO
                BEGIN SIMULATION | \________________________/ .---. / \ \.@-@./
                /`\_/`\ // _ \\
              </pre>
            )}
          </div>
      ...
      <div className="score-display mb-6 border-2 border-terminal-red bg-terminal-red/10">
        <div className="flex justify-between p-2">
          ...
          <div className="flex items-center">
            <p className="text-terminal-green font-bold">
              COMMISSION:{" "}
              <span className="text-terminal-blue animate-pulse">
                x{state.multiplier}
              </span>
            </p>
      ...
      <div className="leaderboard mt-8 border-2 border-terminal-green p-2 bg-black/10">
        <p className="text-terminal-green font-bold mb-2 text-center border-b border-terminal-green pb-1">
          == TOP TRADERS LEADERBOARD ==
        </p>
        {state.leaderboard.map(
          (entry: {wallet: string; score: number}, index: number) => (
            <div
              key={index}
