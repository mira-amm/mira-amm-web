...
const abi = {
  ...
  concreteTypes: [
    ...
    },
    {
      ...
      concreteTypeId:
        "75021c092fbe6c5da8e67b3bb45d05bac56d20ca3deb794f199db139578eee3b",
      metadataTypeId: 4,
    },
    {
      type: "enum interfaces::errors::InputError",
      concreteTypeId:
        "2c16264fa4a4e0c4dceefe1b6eee32bbd8f32e19b79110d831a389a95f37c915",
      metadataTypeId: 5,
    },
    {
    ...
    },
    {
      ...
      concreteTypeId:
        "71d71358b0c76d3c686d18d22a0ed92ab6dc7cdabc753d4c154debcae0a03dcf",
      metadataTypeId: 9,
      typeArguments: [
    ...
    },
    {
      ...
      concreteTypeId:
        "362a6a689aa3d6b3e2d50426f7c94ce2717b22f1df0b7ffe541cbcb25e0b9c65",
      metadataTypeId: 16,
    },
    {
      type: "struct interfaces::events::CreatePoolEvent",
      concreteTypeId:
        "a9a76f9e31034cee0ebff18e0c0dc3b3511e277ab8644fb5b42ab97d62b52037",
      metadataTypeId: 17,
    },
    {
      type: "struct interfaces::events::MintEvent",
      concreteTypeId:
        "ae2069277682335a733c89d400032730e629e08e19f5127cba9ddd54854c1ff6",
      metadataTypeId: 18,
    },
    {
      type: "struct interfaces::events::SwapEvent",
      concreteTypeId:
        "6e2b2beb181a5f3d2c643986a5df4197407de6383085035d82fe20a2d2d779bf",
      metadataTypeId: 19,
    },
    {
...
export class MiraAmmContractInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class MiraAmmContract extends __Contract {
  ...
  declare interface: MiraAmmContractInterface;
  declare functions: {
    ...
    burn: InvokeFunction<
      [pool_id: [AssetIdInput, AssetIdInput, boolean], to: IdentityInput],
      [BN, BN]
    >;
    create_pool: InvokeFunction<
      ...
      [AssetIdOutput, AssetIdOutput, boolean]
    >;
    ...
    mint: InvokeFunction<
      ...
      AssetOutput
    >;
    pool_metadata: InvokeFunction<
      [pool_id: [AssetIdInput, AssetIdInput, boolean]],
      Option<PoolMetadataOutput>
    >;
    set_hook: InvokeFunction<[contract_id?: Option<ContractIdInput>], void>;
    set_protocol_fees: InvokeFunction<
      [volatile_fee: BigNumberish, stable_fee: BigNumberish],
      void
    >;
    swap: InvokeFunction<
      [
