...
export type AmmErrorInput = Enum<{ InsufficientLiquidity: undefined, NoLiquidityAdded: undefined, CannotAddLessThanMinimumLiquidity: undefined, CurveInvariantViolation: [BigNumberish, BigNumberish] }>;
export type AmmErrorOutput = Enum<{ InsufficientLiquidity: void, NoLiquidityAdded: void, CannotAddLessThanMinimumLiquidity: void, CurveInvariantViolation: [BN, BN] }>;
...
export type BurnEventInput = { pool_id: [AssetIdInput, AssetIdInput, boolean], recipient: IdentityInput, liquidity: AssetInput, asset_0_out: BigNumberish, asset_1_out: BigNumberish };
