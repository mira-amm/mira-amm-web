...
import MobilePools from "libs/swap/src/components/pages/liquidity-page/components/Pools/MobilePools/MobilePools";
import DesktopPools from "libs/swap/src/components/pages/liquidity-page/components/Pools/DesktopPools/DesktopPools";
