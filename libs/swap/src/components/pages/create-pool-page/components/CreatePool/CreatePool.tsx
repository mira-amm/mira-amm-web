...
import {CreatePoolPreviewData} from "libs/swap/src/components/pages/create-pool-page/components/CreatePool/PreviewCreatePoolDialog";
...
const PreviewCreatePoolDialog = dynamic(
  () =>
    import(
      "libs/swap/src/components/pages/create-pool-page/components/CreatePool/PreviewCreatePoolDialog"
    ),
  {ssr: false},
);
