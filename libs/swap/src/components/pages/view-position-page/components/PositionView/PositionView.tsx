...
import RemoveLiquidityModalContent from "libs/swap/src/components/pages/view-position-page/components/RemoveLiquidityModalContent/RemoveLiquidityModalContent";
import usePositionData from "@/src/hooks/usePositionData";
import {
  createPoolKey,
  floorToTwoSignificantDigits,
} from "libs/swap/src/utils/common";
import {useCallback, useRef, useState} from "react";
import useRemoveLiquidity from "@/src/hooks/useRemoveLiquidity";
import RemoveLiquiditySuccessModal from "libs/swap/src/components/pages/view-position-page/components/RemoveLiquiditySuccessModal/RemoveLiquiditySuccessModal";
