 ...
 */
import {loadFile} from "libs/swap/src/utils/fileLoader";
import {
  UserRewardsQueryParams,
  UserRewardsResponse,
  UserRewardsService,
} from "./interfaces";
import {NotFoundError} from "libs/swap/src/utils/errors";
import path from "path";
import {Campaign, EpochConfigService} from "../campaigns/interfaces";
import {convertDailyRewardsToTotalRewards} from "libs/swap/src/utils/common";
