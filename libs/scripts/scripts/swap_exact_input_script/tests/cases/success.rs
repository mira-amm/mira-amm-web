...
async fn swap_between_two_volatile_tokens() {
    ...
    let amounts_out = swap_exact_input_script
        .main(token_0_to_swap, token_0_id, 0, vec![pool_id], wallet.address().into(), deadline)
        .with_contracts(&[&amm.instance])
        .with_inputs(inputs)
        .with_outputs(outputs)
    ...
    assert_eq!(wallet_balances_after.asset_a, wallet_balances_before.asset_a - token_0_to_swap);
    assert_eq!(wallet_balances_after.asset_b, wallet_balances_before.asset_b + token_1_expected);
    assert_eq!(pool_metadata_after.reserve_0, pool_metadata_before.reserve_0 + token_0_to_swap);
    assert_eq!(pool_metadata_after.reserve_1, pool_metadata_before.reserve_1 - token_1_expected);
}
...
async fn swap_between_three_volatile_tokens() {
    ...
    assert_eq!(wallet_balances_0_after.asset_a, wallet_balances_0_before.asset_a - token_0_to_swap);
    ...
    assert_eq!(pool_metadata_0_after.reserve_0, pool_metadata_0_before.reserve_0 + token_0_to_swap);
    assert_eq!(
