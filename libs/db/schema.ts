...
export const enum_github_status = pgEnum("enum_github_status", [
  "draft",
  "published",
]);
export const enum__github_v_version_status = pgEnum(
  "enum__github_v_version_status",
  ["draft", "published"],
);
...
export const skills_rels = pgTable(
  ...
  (columns) => ({
    ...
    skills_rels_brands_id_idx: index("skills_rels_brands_id_idx").on(
      columns.brandsID,
    ),
    parentFk: foreignKey({
...
export const github_projects = pgTable(
  "github_projects",
  {
    _order: integer("_order").notNull(),
    _parentID: integer("_parent_id").notNull(),
  ...
  (columns) => ({
    _orderIdx: index("github_projects_order_idx").on(columns._order),
    _parentIDIdx: index("github_projects_parent_id_idx").on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [github.id],
      name: "github_projects_parent_id_fk",
    }).onDelete("cascade"),
  }),
);

export const github = pgTable(
  "github",
  {
    id: serial("id").primaryKey(),
    text: jsonb("text"),
    skills: integer("skills_id").references(() => skills.id, {
      onDelete: "set null",
    }),
    githubStats_totalRepos: numeric("github_stats_total_repos"),
    githubStats_totalCommits: numeric("github_stats_total_commits"),
    githubStats_followers: numeric("github_stats_followers"),
    githubStats_following: numeric("github_stats_following"),
    githubStats_stars: numeric("github_stats_stars"),
    githubStats_forks: numeric("github_stats_forks"),
    _status: enum_github_status("_status").default("draft"),
    updatedAt: timestamp("updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
  ...
  (columns) => ({
    github_skills_idx: index("github_skills_idx").on(columns.skills),
    github__status_idx: index("github__status_idx").on(columns._status),
  }),
);

export const github_rels = pgTable(
  "github_rels",
  {
    id: serial("id").primaryKey(),
    order: integer("order"),
  ...
  (columns) => ({
    order: index("github_rels_order_idx").on(columns.order),
    parentIdx: index("github_rels_parent_idx").on(columns.parent),
    pathIdx: index("github_rels_path_idx").on(columns.path),
    github_rels_brands_id_idx: index("github_rels_brands_id_idx").on(
      columns.brandsID,
    ),
    parentFk: foreignKey({
      columns: [columns["parent"]],
      foreignColumns: [github.id],
      name: "github_rels_parent_fk",
    }).onDelete("cascade"),
    brandsIdFk: foreignKey({
      columns: [columns["brandsID"]],
      foreignColumns: [brands.id],
      name: "github_rels_brands_fk",
    }).onDelete("cascade"),
  }),
);

export const _github_v_version_projects = pgTable(
  "_github_v_version_projects",
  {
    _order: integer("_order").notNull(),
    _parentID: integer("_parent_id").notNull(),
    id: serial("id").primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index("_github_v_version_projects_order_idx").on(columns._order),
    _parentIDIdx: index("_github_v_version_projects_parent_id_idx").on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [_github_v.id],
      name: "_github_v_version_projects_parent_id_fk",
    }).onDelete("cascade"),
  }),
);

export const _github_v = pgTable(
  "_github_v",
  {
    id: serial("id").primaryKey(),
    version_text: jsonb("version_text"),
    version_skills: integer("version_skills_id").references(() => skills.id, {
      onDelete: "set null",
    }),
    version_githubStats_totalRepos: numeric("version_github_stats_total_repos"),
    version_githubStats_totalCommits: numeric(
      "version_github_stats_total_commits",
    ),
    version_githubStats_followers: numeric("version_github_stats_followers"),
    version_githubStats_following: numeric("version_github_stats_following"),
    version_githubStats_stars: numeric("version_github_stats_stars"),
    version_githubStats_forks: numeric("version_github_stats_forks"),
    version__status:
      enum__github_v_version_status("version__status").default("draft"),
    version_updatedAt: timestamp("version_updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
  ...
  (columns) => ({
    _github_v_version_version_skills_idx: index(
      "_github_v_version_version_skills_idx",
    ).on(columns.version_skills),
    _github_v_version_version__status_idx: index(
      "_github_v_version_version__status_idx",
    ).on(columns.version__status),
    _github_v_created_at_idx: index("_github_v_created_at_idx").on(
      columns.createdAt,
    ),
    _github_v_updated_at_idx: index("_github_v_updated_at_idx").on(
      columns.updatedAt,
    ),
    _github_v_latest_idx: index("_github_v_latest_idx").on(columns.latest),
  }),
);

export const _github_v_rels = pgTable(
  "_github_v_rels",
  {
    id: serial("id").primaryKey(),
    order: integer("order"),
  ...
  (columns) => ({
    order: index("_github_v_rels_order_idx").on(columns.order),
    parentIdx: index("_github_v_rels_parent_idx").on(columns.parent),
    pathIdx: index("_github_v_rels_path_idx").on(columns.path),
    _github_v_rels_brands_id_idx: index("_github_v_rels_brands_id_idx").on(
      columns.brandsID,
    ),
    parentFk: foreignKey({
      columns: [columns["parent"]],
      foreignColumns: [_github_v.id],
      name: "_github_v_rels_parent_fk",
    }).onDelete("cascade"),
    brandsIdFk: foreignKey({
      columns: [columns["brandsID"]],
      foreignColumns: [brands.id],
      name: "_github_v_rels_brands_fk",
    }).onDelete("cascade"),
  }),
);
...
export const relations_github_projects = relations(
  github_projects,
  ({one}) => ({
    _parentID: one(github, {
      fields: [github_projects._parentID],
      references: [github.id],
      relationName: "projects",
    }),
  }),
);
export const relations_github_rels = relations(github_rels, ({one}) => ({
  parent: one(github, {
    fields: [github_rels.parent],
    references: [github.id],
    relationName: "_rels",
  }),
  brandsID: one(brands, {
    fields: [github_rels.brandsID],
    references: [brands.id],
    relationName: "brands",
  }),
}));
export const relations_github = relations(github, ({one, many}) => ({
  skills: one(skills, {
    fields: [github.skills],
    references: [skills.id],
    relationName: "skills",
  }),
  projects: many(github_projects, {
    relationName: "projects",
  }),
  _rels: many(github_rels, {
    relationName: "_rels",
  }),
}));
export const relations__github_v_version_projects = relations(
  _github_v_version_projects,
  ({one}) => ({
    _parentID: one(_github_v, {
      fields: [_github_v_version_projects._parentID],
      references: [_github_v.id],
      relationName: "version_projects",
    }),
  }),
);
export const relations__github_v_rels = relations(_github_v_rels, ({one}) => ({
  parent: one(_github_v, {
    fields: [_github_v_rels.parent],
    references: [_github_v.id],
    relationName: "_rels",
  }),
  brandsID: one(brands, {
    fields: [_github_v_rels.brandsID],
    references: [brands.id],
    relationName: "brands",
  }),
}));
export const relations__github_v = relations(_github_v, ({one, many}) => ({
  version_skills: one(skills, {
    fields: [_github_v.version_skills],
    references: [skills.id],
    relationName: "version_skills",
  }),
  version_projects: many(_github_v_version_projects, {
    relationName: "version_projects",
  }),
  _rels: many(_github_v_rels, {
    relationName: "_rels",
  }),
}));
...
type DatabaseSchema = {
  ...
  enum_github_status: typeof enum_github_status;
  enum__github_v_version_status: typeof enum__github_v_version_status;
  users: typeof users;
  ...
  github_projects: typeof github_projects;
  github: typeof github;
  github_rels: typeof github_rels;
  _github_v_version_projects: typeof _github_v_version_projects;
  _github_v: typeof _github_v;
  _github_v_rels: typeof _github_v_rels;
  ...
  relations_github_projects: typeof relations_github_projects;
  relations_github_rels: typeof relations_github_rels;
  relations_github: typeof relations_github;
  relations__github_v_version_projects: typeof relations__github_v_version_projects;
  relations__github_v_rels: typeof relations__github_v_rels;
  relations__github_v: typeof relations__github_v;
};
