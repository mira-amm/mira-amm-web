...
export const enum_app_status = pgEnum("enum_app_status", [
  "draft",
  "published",
]);
export const enum__app_v_version_status = pgEnum("enum__app_v_version_status", [
  "draft",
  "published",
]);
export const enum_design_status = pgEnum("enum_design_status", [
  "draft",
  "published",
]);
export const enum__design_v_version_status = pgEnum(
  "enum__design_v_version_status",
  ["draft", "published"],
);
export const enum_docs_status = pgEnum("enum_docs_status", [
  "draft",
  "published",
]);
export const enum__docs_v_version_status = pgEnum(
  "enum__docs_v_version_status",
  ["draft", "published"],
);
...
export const app = pgTable(
  "app",
  {
    id: serial("id").primaryKey(),
    text: varchar("text"),
    _status: enum_app_status("_status").default("draft"),
    updatedAt: timestamp("updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
  ...
  (columns) => ({
    app__status_idx: index("app__status_idx").on(columns._status),
  }),
);

export const _app_v = pgTable(
  "_app_v",
  {
    id: serial("id").primaryKey(),
    version_text: varchar("version_text"),
    version__status:
      enum__app_v_version_status("version__status").default("draft"),
    version_updatedAt: timestamp("version_updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
  ...
  (columns) => ({
    _app_v_version_version__status_idx: index(
      "_app_v_version_version__status_idx",
    ).on(columns.version__status),
    _app_v_created_at_idx: index("_app_v_created_at_idx").on(columns.createdAt),
    _app_v_updated_at_idx: index("_app_v_updated_at_idx").on(columns.updatedAt),
    _app_v_latest_idx: index("_app_v_latest_idx").on(columns.latest),
  }),
);
...
export const design = pgTable(
  ...
  (columns) => ({
    design__status_idx: index("design__status_idx").on(columns._status),
  }),
);

export const _design_v = pgTable(
  "_design_v",
  {
    id: serial("id").primaryKey(),
    version_embedLink: varchar("version_embed_link").default(
      "https://embed.figma.com/design/OOySUYRs2xEDJRMqY4bppf/MIRA-master-(shared)?node-id=13937-5016&embed-host=share",
    ),
    version_shareLink: varchar("version_share_link").default(
      "https://figma.com/design/OOySUYRs2xEDJRMqY4bppf/MIRA-master-(shared)?node-id=13937-5016&embed-host=share",
    ),
    version__status:
      enum__design_v_version_status("version__status").default("draft"),
    version_updatedAt: timestamp("version_updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
  ...
  (columns) => ({
    _design_v_version_version__status_idx: index(
      "_design_v_version_version__status_idx",
    ).on(columns.version__status),
    _design_v_created_at_idx: index("_design_v_created_at_idx").on(
      columns.createdAt,
    ),
    _design_v_updated_at_idx: index("_design_v_updated_at_idx").on(
      columns.updatedAt,
    ),
    _design_v_latest_idx: index("_design_v_latest_idx").on(columns.latest),
  }),
);
...
export const docs = pgTable(
  ...
  {
    id: serial("id").primaryKey(),
    blog: varchar("blog").default("https://mirror.xyz/miraly.eth"),
    discord: varchar("discord").default("https://discord.gg/6pHdTY6rYq"),
    x: varchar("x").default("https://x.com/MiraProtocol"),
    instagram: varchar("instagram").default("https://instagram.com"),
    facebook: varchar("facebook").default("https://facebook.com"),
    github: varchar("github").default("https://github.com/mira-amm"),
    _status: enum_docs_status("_status").default("draft"),
    updatedAt: timestamp("updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
  ...
  (columns) => ({
    docs__status_idx: index("docs__status_idx").on(columns._status),
  }),
);

export const _docs_v = pgTable(
  "_docs_v",
  {
    id: serial("id").primaryKey(),
    version_blog: varchar("version_blog").default(
      "https://mirror.xyz/miraly.eth",
    ),
    version_discord: varchar("version_discord").default(
      "https://discord.gg/6pHdTY6rYq",
    ),
    version_x: varchar("version_x").default("https://x.com/MiraProtocol"),
    version_instagram: varchar("version_instagram").default(
      "https://instagram.com",
    ),
    version_facebook: varchar("version_facebook").default(
      "https://facebook.com",
    ),
    version_github: varchar("version_github").default(
      "https://github.com/mira-amm",
    ),
    version__status:
      enum__docs_v_version_status("version__status").default("draft"),
    version_updatedAt: timestamp("version_updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
  ...
  (columns) => ({
    _docs_v_version_version__status_idx: index(
      "_docs_v_version_version__status_idx",
    ).on(columns.version__status),
    _docs_v_created_at_idx: index("_docs_v_created_at_idx").on(
      columns.createdAt,
    ),
    _docs_v_updated_at_idx: index("_docs_v_updated_at_idx").on(
      columns.updatedAt,
    ),
    _docs_v_latest_idx: index("_docs_v_latest_idx").on(columns.latest),
  }),
);
...
export const relations_app = relations(app, () => ({}));
export const relations__app_v = relations(_app_v, () => ({}));
export const relations_design = relations(design, () => ({}));
export const relations__design_v = relations(_design_v, () => ({}));
export const relations_docs = relations(docs, () => ({}));
export const relations__docs_v = relations(_docs_v, () => ({}));
...
type DatabaseSchema = {
  ...
  enum_app_status: typeof enum_app_status;
  enum__app_v_version_status: typeof enum__app_v_version_status;
  enum_design_status: typeof enum_design_status;
  enum__design_v_version_status: typeof enum__design_v_version_status;
  enum_docs_status: typeof enum_docs_status;
  enum__docs_v_version_status: typeof enum__docs_v_version_status;
  users: typeof users;
  ...
  app: typeof app;
  _app_v: typeof _app_v;
  design: typeof design;
  _design_v: typeof _design_v;
  docs: typeof docs;
  _docs_v: typeof _docs_v;
  ...
  relations_app: typeof relations_app;
  relations__app_v: typeof relations__app_v;
  relations_design: typeof relations_design;
  relations__design_v: typeof relations__design_v;
  relations_docs: typeof relations_docs;
  relations__docs_v: typeof relations__docs_v;
};
