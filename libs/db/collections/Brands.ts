  ...
  await Promise.all(
    [
      ...
      },
      {
        name: "Swaylend",
        description:
          "Experience lightning-fast, low-cost lending and borrowing on Fuel.",
        domain: "https://swaylend.com",
        symbol:
          "https://swaylend.com/_next/static/media/dark-logo.f8b6fe51.svg",
      },
      {
      ...
      },
      {
        ...
        symbol:
          "https://axfixdzedlzzumwcftks.supabase.co/storage/v1/object/sign/staging/symbol.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6InN0b3JhZ2UtdXJsLXNpZ25pbmcta2V5XzA5OTIwOGVlLTRkNmUtNGI4ZC1hN2VjLTcyMDEzOGY1YTEyNCJ9.eyJ1cmwiOiJzdGFnaW5nL3N5bWJvbC5wbmciLCJpYXQiOjE3NDcxNzA3MTEsImV4cCI6MTc3ODcwNjcxMX0.jfrjqRAYnZzXCpLiUQePvnAWDDlFpvv6rdrgDxtJwJQ",
      },
      {
