      ...
      tabs: [
        {
          ...
          label: "🕹 Microgame",
          description:
            "Promotional Glitch Scavenger Hunt minigame for the launch of Microchain.",
          fields: [
            {
              type: "tabs",
              tabs: [
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      defaultValue: () => [
                        {
                          name: "title",
                          text: "T-REX TECHNOLOGIES: DLM-2000 PROTOTYPE v0.8.5b",
                        },
                        {name: "label", text: "T-REX SECURITY SYSTEM:"},
                        {
                          name: "error",
                          text: "SECURITY BREACH DETECTED. INVALID EXECUTIVE CREDENTIALS.",
                        },
                        {
                          name: "hint",
                          text: "HINT: The DLM-2000 infrastructure is built on this technology...",
                        },
                      ],
                    },
                  ],
                  ...
                  fields: [
                    {
                      ...
                      type: "text",
                      defaultValue: () =>
                        "CEO ACCESS GRANTED - WELCOME TO DLM-2000, DEREK DINO",
                    },
                    {
                      name: "lastLogin",
                      type: "text",
                      defaultValue: () =>
                        "> Last login: 4/20/2025, 10:15:19 PM on T-REX SECURE NETWORK",
                    },
                    {
                      name: "welcome",
                      type: "text",
                    ...
                    },
                    {
                      name: "optionsTitle",
                      type: "text",
                      defaultValue: () => "== EXECUTIVE COMMAND OPTIONS ==",
                    },
                    {
                      name: "options",
                      type: "array",
                      ...
                      defaultValue: () => [
                        ...
                        },
                        {
                          option: "game",
                          description:
                            "Test the Decentralized Market Simulator",
                        },
                        {
                          option: "help",
                  ...
                  fields: [
                    {
                      name: "sectionTitle",
                      type: "text",
                      defaultValue: () => "DECENTRALIZED MARKET SIMULATOR",
                    },
                    {
                      name: "subtitle",
                      type: "text",
                    ...
                    {
                      name: "tradingInstructionsTitle",
                      type: "text",
                      defaultValue: () => "TRADING INSTRUCTIONS:",
                    },
                    {
                      name: "instructions",
                      type: "array",
