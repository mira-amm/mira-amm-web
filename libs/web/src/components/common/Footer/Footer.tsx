...
export default function Footer() {
  return (
    <footer className="flex flex-col border-t dark:border-t-mc-grey-4 w-full py-4 px-4 max-w-6xl mx-auto mt-32">
      <div className="flex flex-col gap-4 lg:flex-row lg:justify-between lg:items-center lg:gap-[134px]">
        <Logo isFooter />
        <div className="flex flex-col lg:flex-row gap-3 text-base leading-[22px] text-content-tertiary dark:text-mc-grey-4 font-normal lg:w-[650px] lg:text-lg lg:leading-6">
          <a
            className="lg:px-4 text-base text-content-tertiary dark:text-mc-grey-4 hover:text-content-primary hover:no-underline"
            href={DiscordLink}
            target="_blank"
            rel="noopener"
          >
