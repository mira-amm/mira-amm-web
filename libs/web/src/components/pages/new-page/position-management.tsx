...
import {NewMiraBlock} from "./new-components/new-mira-block";
...
const PositionManagementPage = () => {
  ...
  return (
    <main className="flex flex-col gap-4 mx-auto lg:w-[716px] w-full lg:px-4 lg:py-8">
      ...
      <section className="flex flex-col gap-4 desktopOnly">
        ...
        <div className="flex gap-3 w-full h-70">
          <div className="w-1/2 h-full grow-1 flex-1">
            <NewMiraBlock pool={pool} />
          </div>
          <div className="w-1/2 p-4 rounded-[12px] flex flex-col gap-4 bg-background-grey-dark border-border-secondary border-[11px] dark:border-0 dark:bg-background-grey-dark">
            <p className="text-[16px] font-semibold leading-[19px] border-b border-background-grey-light pb-3">
              Pool reserves
            </p>
            <NewReserveItem
              assetId={pool[0].bits}
