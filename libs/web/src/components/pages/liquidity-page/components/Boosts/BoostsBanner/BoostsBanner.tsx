...
export function BoostsBanner() {
  return (
    <div className="flex flex-col justify-between gap-2.5 p-4 rounded-[10px] bg-[url('/images/pointsGradientBackground.png')] dark:bg-[linear-gradient(170deg,#262f5f_35%,#c41cff_100%)]">
      <PointsIcon />
