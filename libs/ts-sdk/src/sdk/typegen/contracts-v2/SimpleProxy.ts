...
export enum SimpleProxyErrorInput { AlreadyInitialized = 'AlreadyInitialized', InvalidOwner = 'InvalidOwner' };
export enum SimpleProxyErrorOutput { AlreadyInitialized = 'AlreadyInitialized', InvalidOwner = 'InvalidOwner' };
...
const abi = {
  ...
  "concreteTypes": [
    ...
    },
    {
      ...
      "concreteTypeId": "1b808c062f9cb48a1ff8a0c33a9f590016122eed669e86a6c152c7b4a19d8239",
      "metadataTypeId": 1
    },
    {
...
export class SimpleProxy extends __Contract {
  ...
  declare functions: {
    ...
    initialize_proxy: InvokeFunction<[owner: IdentityInput, target: ContractIdInput], void>;
