...
const PositionView = ({pool}: Props) => {
  ...
  const aprActual = !isIndexerWorking
    ? aprValue === "NaN" || Number(aprValue) <= 0
      ? "n/a"
      : aprValue
    : aprValue;
            ...
            >
              ...
              <InfoToolTip
                ...
                content={
                  aprValue === "NaN"
                    ? "No data available"
                    : "Data unavailable due to an indexer issue. Updates will be available shortly."
                }
              />
            </span>
          </p>
      ...
      <section className={clsx(styles.contentSection, "desktopOnly")}>
        ...
        <div className={styles.topRow}>
          ...
          <div className={styles.infoBlocks}>
            <div className={styles.infoBlock}>
              <p>Liquidity</p>
              <p className={clsx(styles.flexContainer)}>
                APR &nbsp;
                <span
                  className={clsx(
                    styles.pending,
