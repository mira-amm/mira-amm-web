...
const Configuration: UserConfig = {
  ...
  helpUrl: "https://docs.mira.ly/contributing/conventional-commits",
  prompt: {
    settings: {
    ...
    questions: {
      type: {
        ...
        enum: {
          ...
          chore: {
            description:
              "Other changes that don't modify src or test files, such as installing packages, updating config files, etc.",
            title: "Chores",
            emoji: "♻",
          },
          ...
          docs: {
            description:
              "Adding missing docs or correcting existing docs (use feat if adding a feature to docs site)",
            title: "Documentation",
            emoji: "📚",
          },
          refactor: {
          ...
          style: {
            description:
              "Linting or formatting changes that do not affect the meaning of the code (white-space, semi-colons, parentheses, etc)",
            title: "Styles",
            emoji: "💎",
          },
          perf: {
          ...
          hotfix: {
            description:
              "For time-sensitive, emergency fixes (e.g., critical bugs that need to be fixed immediately)",
            title: "Hotfix",
            emoji: "🗑",
          },
        },
