...
export default function Page() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <section className="flex flex-col gap-6 p-4 rounded-2xl w-full max-w-lg mx-auto bg-background-grey-dark border-border-secondary border-[12px] dark:border-0 z-[5]">
        <div className="flex items-center justify-between border-b border-background-grey-light pb-4 text-content-grey font-medium text-base leading-5 gap-2">
