    ...
    <>
      ...
      <div className="mb-6">
        ...
        <ul className="space-y-1 ml-4">
          <li>
            {"> "}
            <span className="text-terminal-green font-bold">notes</span> -
            Access confidential project files
          </li>
          <li>
            {"> "}
          ...
          <li>
            {"> "}
            <span className="text-terminal-green font-bold">game</span> - Test
            the Decentralized Market Simulator
          </li>
          <li>
            {"> "}
            <span className="text-terminal-green font-bold">help</span> - Show
            T-REX command options
          </li>
          <li>
            {"> "}
          ...
          <li>
            {"> "}
            <span className="text-terminal-green font-bold">logout</span> -
            Engage T-REX security lockdown
          </li>
        </ul>
      </div>
