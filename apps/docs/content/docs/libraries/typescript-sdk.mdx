...
The SDK provides a set of tools to interact with Microchain.

It allows developers to perform actions such as:
- Adding/removing liquidity
- Swapping tokens
- Querying liquidity pools, and more

The SDK is built on top of the `fuels` library and supports both transaction-based & readonly operations.
...
<Cards>
  <Card
    ...
    href="https://github.com/mira-amm/mira-amm-web/tree/main/libs/ts-sdk"
  />
  <Card
    title="NPM"
    icon={
